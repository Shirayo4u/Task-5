...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.addCar(new Car("BMW M5", 666));
      userService.addCar(new Car("AUDI RX7", 777));
      userService.addCar(new Car("VW Polo", 555));
      userService.addCar(new Car("HYUINDAY Accent", 888));
      ...
      System.out.println(userService.getUserFromCar("BMW M5", 666));
